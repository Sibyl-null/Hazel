...
namespace Hazel
{
	...
	void EditorLayer::OnAttach()
	{
		...
		m_ActiveScene->GetReg().emplace<TransformComponent>(m_SquareEntity);
		m_ActiveScene->GetReg().emplace<SpriteRendererComponent>(m_SquareEntity, glm::vec4{0.0f, 1.0f, 0.0f, 1.0f});
	}
